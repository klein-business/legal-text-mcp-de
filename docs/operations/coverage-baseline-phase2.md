...
`max(85, baseline)` = `92%`. The floor is monotonic — Phase 3 and later
may raise it but never lower it.
...
mcp/parser.py                                        233    100    57%   10-31, 50, 102-103, 174-215, 241-246, 253, 256, 281-283, 295-298, 310-321, 347-369, 386-387, 418, 434, 444-447, 452-473
mcp/server.py                                         60      3    95%   134-136
--------------------------------------------------------------------------------
TOTAL                                               6371    530    92%
```
