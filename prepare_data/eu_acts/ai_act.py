...
"""KI-Verordnung / AI Act (CELEX 32024R1689) loader."""
...
CELEX = "32024R1689"
DISPLAY_CODE = "AIAct"
DISPLAY_NAME = "Verordnung (EU) 2024/1689 (KI-Verordnung / AI Act)"
...
class AIAct:
    ...
    def fetch_and_normalise(self) -> NormalizedLaw:
        """Resolve, fetch, parse, and return the AI Act as a NormalizedLaw."""
