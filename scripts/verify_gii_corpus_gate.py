...
from legal_text_mcp_de.legal_texts.gii_bulk import build_gii_corpus_gate_artifact, write_gii_corpus_gate_artifact  # type: ignore[import-untyped]
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--retrieved-at", default="2026-05-15T00:00:00Z", help="Timestamp to stamp fixture artifacts with."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    upstream_limitations = (
        json.loads(Path(args.upstream_limitations).read_text(encoding="utf-8")) if args.upstream_limitations else None
    )
