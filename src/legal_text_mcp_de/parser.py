...
class LawNode:
    def __init__(self, node_type: str, id: Optional[str], name: Optional[str]):
...
class LawLibrary:
    ...
    def get_available_laws(self, search_string: Optional[str] = None) -> List[Dict[str, str]]:
        ...
        all_laws = [{"code": code, "title": parser.full_title} for code, parser in self.laws.items()]
        ...
        matched_laws = [
            {"code": code, "title": self.laws[code].full_title, "similarity": score}
