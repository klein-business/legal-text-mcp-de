...
from prepare_data.eu_acts.ai_act import AIAct, CELEX, DISPLAY_CODE
...
def test_ai_act_resolves_and_normalises():
    ...
    act = AIAct(resolve_xml_url=fake_resolve, http_get=fake_http_get)
