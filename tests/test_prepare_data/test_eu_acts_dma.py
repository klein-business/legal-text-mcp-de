...
from prepare_data.eu_acts.dma import CELEX, DISPLAY_CODE, DMAAct
...
def test_dma_resolves_and_normalises():
    ...
    act = DMAAct(resolve_xml_url=fake_resolve, http_get=fake_http_get)
